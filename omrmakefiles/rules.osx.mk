...
GLOBAL_CPPFLAGS += -DOSX -D_REENTRANT -D_FILE_OFFSET_BITS=64
...
ifneq (,$(findstring executable,$(ARTIFACT_TYPE)))
  ## Default Libraries
  DEFAULT_LIBS:=-lm -lpthread -lc -ldl -lutil -Wl,-rpath,\$$ORIGIN
...
GLOBAL_LDFLAGS+=-Wl
GLOBAL_LDFLAGS+=-Wl,$($(MODULE_NAME)_LINKER_EXPORT_SCRIPT)
GLOBAL_LDFLAGS+=-rpath -Xlinker -Xlinker
