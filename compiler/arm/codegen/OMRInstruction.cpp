...
static TR::Instruction *expandBlongLessThan(TR::Node          *node,
   ...
   // are zero!).
   cursor = generateTrg1ImmInstruction(cg, TR::InstOpCode::ARMOp_mov, node, result, !trueValue, 0, cursor);
   cursor = generateTrg1Src2Instruction(cg, TR::InstOpCode::ARMOp_sub_r, node, temp, aLo, bLo, cursor);
   cursor = generateTrg1Src2Instruction(cg, TR::InstOpCode::ARMOp_sbc_r, node, temp, aHi, bHi, cursor);
   cursor = generateTrg1ImmInstruction(cg, TR::InstOpCode::ARMOp_mov, node, result, trueValue, 0, cursor);
...
//   TR::LabelSymbol *label1;
   switch(getOpCode().getOpCodeValue())
      ...
      case TR::InstOpCode::ARMOp_iflong:
         ...
         cursor = generateSrc2Instruction(cg(), TR::InstOpCode::ARMOp_cmp, currentNode, getSourceRegister(0), getSourceRegister(2), cursor);
         ...
         cursor = generateSrc2Instruction(cg(), TR::InstOpCode::ARMOp_cmp, currentNode, getSourceRegister(1), getSourceRegister(3), cursor);
      ...
      case TR::InstOpCode::ARMOp_setblong:
         switch (getConditionCode())
            ...
            case ARMConditionCodeNE:
               cursor = generateTrg1ImmInstruction(cg(), TR::InstOpCode::ARMOp_mov, currentNode, getTargetRegister(0), 0, 0, cursor);
               cursor = generateSrc2Instruction(cg(), TR::InstOpCode::ARMOp_cmp, currentNode, getSourceRegister(0), getSourceRegister(2), cursor);
               cursor = generateSrc2Instruction(cg(), TR::InstOpCode::ARMOp_cmp, currentNode, getSourceRegister(1), getSourceRegister(3), cursor);
               cursor->setConditionCode(ARMConditionCodeEQ);
               cursor = generateTrg1ImmInstruction(cg(), TR::InstOpCode::ARMOp_mov, currentNode, getTargetRegister(0), 1, 0, cursor);
      ...
      case TR::InstOpCode::ARMOp_lcmp:
         ...
         cursor = generateTrg1ImmInstruction(cg(), TR::InstOpCode::ARMOp_mvn, currentNode, getTargetRegister(0), 0, 0, cursor);
         cursor->setConditionCode(ARMConditionCodeLT);
...
/*
      ...
      case TR::InstOpCode::ARMOp_idiv:
         ...
         cursor = new (cg()->trHeapMemory()) TR::ARMTrg1Src2Instruction(cursor, TR::InstOpCode::ARMOp_and, currentNode, getTargetRegister(2), getSourceRegister(2), getTargetRegister(2), cg());
