...
void TR_BitVector::print(OMR::Logger *log, TR::Compilation *comp) { comp->getDebug()->print(log, this); }

void TR_SingleBitContainer::print(OMR::Logger *log, TR::Compilation *comp) { comp->getDebug()->print(log, this); }
