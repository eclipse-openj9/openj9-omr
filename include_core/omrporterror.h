...
#define OMRPORT_ERROR_SYSINFO_ERROR_GETTING_CPU_LOAD (OMRPORT_ERROR_SYSINFO_BASE - 35)
#define OMRPORT_ERROR_SYSINFO_ERROR_GETTING_CPU_CAPACITY (OMRPORT_ERROR_SYSINFO_BASE - 36)
