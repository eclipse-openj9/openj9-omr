...
#define S390OpProp_UsesTarget             (int64_t)CONSTANT64(0x0000000000000001)
#define S390OpProp_SingleFP               (int64_t)CONSTANT64(0x0000000000000002)
#define S390OpProp_DoubleFP               (int64_t)CONSTANT64(0x0000000000000004)
#define S390OpProp_SetsZeroFlag           (int64_t)CONSTANT64(0x0000000000000008)
#define S390OpProp_SetsSignFlag           (int64_t)CONSTANT64(0x0000000000000010)
#define S390OpProp_SetsCarryFlag          (int64_t)CONSTANT64(0x0000000000000020)
#define S390OpProp_SetsOverflowFlag       (int64_t)CONSTANT64(0x0000000000000040)
#define S390OpProp_BranchOp               (int64_t)CONSTANT64(0x0000000000000080)
#define S390OpProp_IsLoad                 (int64_t)CONSTANT64(0x0000000000000100)
#define S390OpProp_IsStore                (int64_t)CONSTANT64(0x0000000000000200)
#define S390OpProp_IsSync                 (int64_t)CONSTANT64(0x0000000000000400)
#define S390OpProp_ReadsMultipleRegs      (int64_t)CONSTANT64(0x0000000000000800)
#define S390OpProp_SetsMultipleRegs       (int64_t)CONSTANT64(0x0000000000001000)
#define S390OpProp_Is64Bit                (int64_t)CONSTANT64(0x0000000000002000)
#define S390OpProp_Is32Bit                (int64_t)CONSTANT64(0x0000000000004000)
#define S390OpProp_Is32To64Bit            (int64_t)CONSTANT64(0x0000000000008000)
#define S390OpProp_IsCall                 (int64_t)CONSTANT64(0x0000000000010000)
#define S390OpProp_ReadsCC                (int64_t)CONSTANT64(0x0000000000020000)
#define S390OpProp_SetsCompareFlag        (int64_t)CONSTANT64(0x0000000000040000)
#define S390OpProp_SetsCC                 (int64_t)CONSTANT64(0x0000000000080000)
#define S390OpProp_LongDispSupported      (int64_t)CONSTANT64(0x0000000000100000)
#define S390OpProp_IsExtendedImmediate    (int64_t)CONSTANT64(0x0000000000200000)
#define S390OpProp_UsesRegPairForTarget   (int64_t)CONSTANT64(0x0000000000400000)
#define S390OpProp_UsesRegPairForSource   (int64_t)CONSTANT64(0x0000000000800000)
#define S390OpProp_UsesRegRangeForTarget  (int64_t)CONSTANT64(0x0000000001000000)
#define S390OpProp_IsRegCopy              (int64_t)CONSTANT64(0x0000000002000000)
#define S390OpProp_Trap                   (int64_t)CONSTANT64(0x0000000004000000)
#define S390OpProp_ReadsDFPRoundingMode   (int64_t)CONSTANT64(0x0000000008000000)
#define S390OpProp_SetsDFPRoundingMode    (int64_t)CONSTANT64(0x0000000010000000)
#define S390OpProp_ReadsFPC               (int64_t)CONSTANT64(0x0000000020000000)
#define S390OpProp_SetsFPC                (int64_t)CONSTANT64(0x0000000040000000)
#define S390OpProp_UsesImplicitRegisters  (int64_t)CONSTANT64(0x0000000080000000)
#define S390OpProp_TargetHW               (int64_t)CONSTANT64(0x0000000100000000)
#define S390OpProp_TargetLW               (int64_t)CONSTANT64(0x0000000200000000)
#define S390OpProp_SrcHW                  (int64_t)CONSTANT64(0x0000000400000000)
#define S390OpProp_SrcLW                  (int64_t)CONSTANT64(0x0000000800000000)
#define S390OpProp_Src2HW                 (int64_t)CONSTANT64(0x0000001000000000)
#define S390OpProp_Src2LW                 (int64_t)CONSTANT64(0x0000002000000000)
#define S390OpProp_HasTwoMemoryReferences (int64_t)CONSTANT64(0x0000004000000000)
#define S390OpProp_ImplicitlyUsesGPR0     (int64_t)CONSTANT64(0x0000008000000000)
#define S390OpProp_ImplicitlyUsesGPR1     (int64_t)CONSTANT64(0x0000010000000000)
#define S390OpProp_ImplicitlyUsesGPR2     (int64_t)CONSTANT64(0x0000020000000000)
#define S390OpProp_ImplicitlySetsGPR0     (int64_t)CONSTANT64(0x0000040000000000)
#define S390OpProp_ImplicitlySetsGPR1     (int64_t)CONSTANT64(0x0000080000000000)
#define S390OpProp_ImplicitlySetsGPR2     (int64_t)CONSTANT64(0x0000100000000000)
#define S390OpProp_IsCompare              (int64_t)CONSTANT64(0x0000200000000000)
#define S390OpProp_MayUseRegPairForTarget (int64_t)CONSTANT64(0x0000400000000000)
#define S390OpProp_IsYForm                (int64_t)CONSTANT64(0x0000800000000000)
#define S390OpProp_IsImplicitLoad         (int64_t)CONSTANT64(0x0001000000000000)
#define S390OpProp_IsImplicitStore        (int64_t)CONSTANT64(0x0002000000000000)
#define S390OpProp_MemRefOneIsStore       (int64_t)CONSTANT64(0x0004000000000000)
#define S390OpProp_MemRefOneIsLoad        (int64_t)CONSTANT64(0x0008000000000000)
#define S390OpProp_MemRefTwoIsStore       (int64_t)CONSTANT64(0x0010000000000000)
#define S390OpProp_MemRefTwoIsLoad        (int64_t)CONSTANT64(0x0020000000000000)
#define S390OpProp_SSSchedulingCandidate  (int64_t)CONSTANT64(0x0040000000000000)
#define S390OpProp_IsExecutionHint        (int64_t)CONSTANT64(0x0080000000000000)
#define S390OpProp_SetsOperand1           (int64_t)CONSTANT64(0x0100000000000000)
#define S390OpProp_SetsOperand2           (int64_t)CONSTANT64(0x0200000000000000)
#define S390OpProp_SetsOperand3           (int64_t)CONSTANT64(0x0400000000000000)
#define S390OpProp_SetsOperand4           (int64_t)CONSTANT64(0x0800000000000000)
#define S390OpProp_ImplicitlySetsGPR3     (int64_t)CONSTANT64(0x1000000000000000)
#define S390OpProp_ImplicitlySetsGPR4     (int64_t)CONSTANT64(0x2000000000000000)
#define S390OpProp_ImplicitlySetsGPR5     (int64_t)CONSTANT64(0x4000000000000000)
#define S390OpProp_IsSignedImmediate      (int64_t)CONSTANT64(0x8000000000000000)

/* Instruction Properties 2 (One hot encoding) */
#define S390OpProp2_UsesM3                (int64_t)CONSTANT64(0x0000000000000001)
#define S390OpProp2_UsesM4                (int64_t)CONSTANT64(0x0000000000000002)
#define S390OpProp2_UsesM5                (int64_t)CONSTANT64(0x0000000000000004)
#define S390OpProp2_UsesM6                (int64_t)CONSTANT64(0x0000000000000008)
#define S390OpProp2_HasExtendedMnemonic   (int64_t)CONSTANT64(0x0000000000000010)
#define S390OpProp2_VectorStringOp        (int64_t)CONSTANT64(0x0000000000000020)
#define S390OpProp2_VectorFPOp            (int64_t)CONSTANT64(0x0000000000000040)
