...
# Look in /usr/local/include first.
find_path(DWARF_H_LOCAL_INCLUDE_DIR "dwarf.h" PATHS "/usr/local/include" NO_DEFAULT_PATH)

if(DWARF_H_LOCAL_INCLUDE_DIR)
	list(APPEND DWARF_H_INCLUDE_DIRS "${DWARF_H_LOCAL_INCLUDE_DIR}")
...
# Look in /usr/local/include first.
find_path(LIBDWARF_H_LOCAL_INCLUDE_DIR "libdwarf.h" PATHS "/usr/local/include" NO_DEFAULT_PATH)

if(LIBDWARF_H_LOCAL_INCLUDE_DIR)
	list(APPEND LIBDWARF_H_INCLUDE_DIRS "${LIBDWARF_H_LOCAL_INCLUDE_DIR}")
