...
TR_S390PostRAPeephole::ConditionalBranchReduction(TR::InstOpCode::Mnemonic branchOPReplacement)
   ...
   if (!TR::Compiler->target.cpu.getSupportsArch(TR::CPU::TR_z13) || disabled)
      return false;
...
TR_S390PostRAPeephole::trueCompEliminationForCompare()
   {
   // z10 specific
   if (!TR::Compiler->target.cpu.getSupportsArch(TR::CPU::TR_z10) || TR::Compiler->target.cpu.getSupportsArch(TR::CPU::TR_z196))
      {
      return false;
      }
...
TR_S390PostRAPeephole::reloadLiteralPoolRegisterForCatchBlock()
   ...
   bool isZ10 = TR::Compiler->target.cpu.getSupportsArch(TR::CPU::TR_z10);
      ...
      switch (_cursor->getOpCodeValue())
        ...
        case TR::InstOpCode::STDY:
         ...
         case TR::InstOpCode::EX:
            ...
            if (_cursor->isOutOfLineEX() && !comp()->getCurrentBlock()->isCold() && !(bool)disableEXRLDispatch && TR::Compiler->target.cpu.getSupportsArch(TR::CPU::TR_z10))
               inlineEXtarget();
            break;
            }
