...
typedef struct OMRPortPlatformGlobals {
	...
	char *vmem_tmpdir_path; /**< Directory to store temporary files used for memory disclaiming */
#endif /* defined(LINUX) */
...
#define PPG_vmem_tmpdir_path (portLibrary->portGlobals->platformGlobals.vmem_tmpdir_path)
#endif /* defined(LINUX) */
