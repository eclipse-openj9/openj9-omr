...
void TR_Debug::print(OMR::Logger *log, TR::RVHelperCallSnippet *snippet)
{
    ...
    log->printf("jal \tra, " POINTER_PRINTF_FORMAT "\t\t; %s%s", target, getName(snippet->getDestination()), info);
