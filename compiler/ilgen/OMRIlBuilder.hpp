...
public:
    ...
    TR::IlValue *genCall(const char *name, TR::SymbolReference *methodSymRef, int32_t numArgs,
...
protected:
    ...
    void traceSwitch(const char *name, TR::IlValue *selectorValue, TR::IlBuilder *defaultBuilder, uint32_t numCases,
        JBCase **cases);
