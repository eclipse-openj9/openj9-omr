...
TR::OptionTable OMR::Options::_jitOptions[] = {
   ...
   {"breakOnOOM",         "D\tbreak when the jit runs out of memory", SET_OPTION_BIT(TR_BreakOnOOM), "F"},
   ...
   {"disableTieredCodeCache",             "D\tdo not separate code cache into cold and warm",   SET_OPTION_BIT(TR_DisableTieredCodeCache), "F", NOT_IN_SUBSET},
...
#ifdef J9_PROJECT_SPECIFIC
   {"traceHCRGuardInsertion",           "L\ttrace HCR guard insertion",                    TR::Options::traceOptimization, hcrGuardInsertion, 0, "P"},
