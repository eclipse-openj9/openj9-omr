...
void
S390OpCodesTest::compileShiftOrRolTestMethods()
   {
   int32_t rc = 0;
...
void
S390OpCodesTest::invokeShiftOrRolTests()
   {
   int32_t rc = 0;
   char resolvedMethodName [RESOLVED_METHOD_NAME_LENGTH];
   uint32_t testCaseNum = 0;
...
void
S390OpCodesTest::compileDisabledShiftOrRolTestMethods()
   {
   int32_t rc = 0;
...
void
S390OpCodesTest::invokeDisabledShiftOrRolTests()
   {
   int32_t rc = 0;
   char resolvedMethodName [RESOLVED_METHOD_NAME_LENGTH];
   uint32_t testCaseNum = 0;
