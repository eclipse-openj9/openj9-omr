...
TR::Optimization *OMR::LocalDeadStoreElimination::create(TR::OptimizationManager *manager)
   {
   return new (manager->allocator()) TR::LocalDeadStoreElimination(manager);
   }

OMR::LocalDeadStoreElimination::LocalDeadStoreElimination(TR::OptimizationManager *manager)
   : TR::Optimization(manager)
   {}

void
OMR::LocalDeadStoreElimination::setIsFirstReferenceToNode(TR::Node *parent, int32_t index, TR::Node *node)
   {
   parent ? node->setSideTableIndex(1) : node->setSideTableIndex(0);
   }

bool
OMR::LocalDeadStoreElimination::isFirstReferenceToNode(TR::Node *parent, int32_t index, TR::Node *node)
   {
   return (node->getSideTableIndex() <= 1);
   }

int32_t OMR::LocalDeadStoreElimination::perform()
   {
   if (trace())
...
int32_t OMR::LocalDeadStoreElimination::performOnBlock(TR::Block *block)
   {
   if (block->getEntry())
      {
...
void OMR::LocalDeadStoreElimination::prePerformOnBlocks()
   {
...
void OMR::LocalDeadStoreElimination::postPerformOnBlocks()
   {
   }

bool OMR::LocalDeadStoreElimination::isNonRemovableStore(TR::Node *storeNode, bool &seenIdentityStore)
   {
...
void OMR::LocalDeadStoreElimination::transformBlock(TR::TreeTop * entryTree, TR::TreeTop * exitTree)
   {
   _curTree = entryTree;
...
TR::TreeTop *OMR::LocalDeadStoreElimination::removeStoreTree(TR::TreeTop *treeTop)
   {
...
// the same object.
//
bool OMR::LocalDeadStoreElimination::isIdentityStore(TR::Node *storeNode)
   {
...
void OMR::LocalDeadStoreElimination::examineNode(TR::Node *parent, int32_t childNum, TR::Node *node, SharedBitVector &deadSymbolReferences)
   {
...
//
bool OMR::LocalDeadStoreElimination::isEntireNodeRemovable(TR::Node *storeNode)
   {
...
void OMR::LocalDeadStoreElimination::setExternalReferenceCountToTree(TR::Node *node, rcount_t *externalReferenceCount)
   {
...
bool OMR::LocalDeadStoreElimination::seenIdenticalStore(TR::Node *node)
   {
...
bool OMR::LocalDeadStoreElimination::areLhsOfStoresSyntacticallyEquivalent(TR::Node *node1, TR::Node *node2)
   {
   int32_t childAdjust;
...
void OMR::LocalDeadStoreElimination::adjustStoresInfo(TR::Node *node, SharedBitVector &deadSymbolReferences)
   {
...
//
TR::Node* OMR::LocalDeadStoreElimination::getAnchorNode(TR::Node *parentNode, int32_t nodeIndex, TR::Node *node, TR::TreeTop *treeTop, TR::NodeChecklist& visited)
   {
...
void OMR::LocalDeadStoreElimination::setupReferenceCounts(TR::Node *node)
   {
...
void OMR::LocalDeadStoreElimination::eliminateDeadObjectInitializations()
   {
   //
...
void OMR::LocalDeadStoreElimination::findLocallyAllocatedObjectUses(LDSBitVector &usedLocalObjectSymbols, TR::Node *parent, int32_t childNum, TR::Node *node, vcount_t visitCount)
   {
   if (node->getOpCode().hasSymbolReference() &&
...
bool OMR::LocalDeadStoreElimination::examineNewUsesForKill(TR::Node *node, TR::Node *storeNode, List<TR::Node> *currentNews, List<TR::Node> *removedNews, TR::Node *parent, int32_t childNum, vcount_t visitCount)
   {
...
void OMR::LocalDeadStoreElimination::killStoreNodes(TR::Node *node) {
