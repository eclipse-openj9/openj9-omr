...
#include "optimizer/OMRLocalDeadStoreElimination.hpp"
...
class LocalDeadStoreElimination : public OMR::LocalDeadStoreElimination
   {
   public:

   LocalDeadStoreElimination(TR::OptimizationManager *manager) :
      OMR::LocalDeadStoreElimination(manager) {}
   };
