...
class S390RSInstruction : public TR::S390RegInstruction
   ...
   S390RSInstruction(TR::InstOpCode::Mnemonic    op,
                        ...
                        uint32_t          imm,
                        TR::CodeGenerator *cg)
           : S390RegInstruction(op, n, treg, cg), _sourceImmediate(imm), _maskImmediate(0), _idx(-1), _hasMask(false), _hasImmediate(true), _kind(IsRS)
      {
   ...
   S390RSInstruction(TR::InstOpCode::Mnemonic    op,
           ...
           : S390RegInstruction(op, n, treg, precedingInstruction, cg), _kind(IsRS),
             _sourceImmediate(imm), _maskImmediate(0), _idx(-1), _hasMask(false), _hasImmediate(true)
      {
      // 1 Register is specified - If it is not a register pair, make sure instruction doesn't take a range (i.e. STM).
      TR_ASSERT(treg->getRegisterPair() || !getOpCode().usesRegRangeForTarget(),
               "OpCode [%s] requires a register range.\n",
   ...
   S390RSInstruction(TR::InstOpCode::Mnemonic    op,
                        ...
                        TR::CodeGenerator *cg)
           : S390RegInstruction(op, n, treg, _conditions, cg), _sourceImmediate(imm), _maskImmediate(0), _idx(-1), _hasMask(false), _hasImmediate(true), _kind(IsRS)
   ...
   S390RSInstruction(TR::InstOpCode::Mnemonic           op,
                        ...
                        TR::CodeGenerator        *cg)
           : S390RegInstruction(op, n, treg, cg), _sourceImmediate(0), _maskImmediate(0), _idx(-1), _hasMask(false), _hasImmediate(false), _kind(IsRS)
      {
   ...
   S390RSInstruction(TR::InstOpCode::Mnemonic           op,
           ...
           : S390RegInstruction(op, n, treg, precedingInstruction, cg),
             _sourceImmediate(0), _maskImmediate(0), _idx(-1), _hasMask(false), _hasImmediate(false), _kind(IsRS)
      {
      useSourceMemoryReference(mf);
      setupThrowsImplicitNullPointerException(n,mf);
      if (mf->getUnresolvedSnippet() != NULL)
   ...
   S390RSInstruction(TR::InstOpCode::Mnemonic op,
                        ...
                        TR::CodeGenerator        *cg)
           : S390RegInstruction(op, n, treg, precedingInstruction, cg),
             _sourceImmediate(0), _maskImmediate(mask), _idx(-1), _hasMask(true), _hasImmediate(false), _kind(IsRS)
      {
      useSourceMemoryReference(mf);
      setupThrowsImplicitNullPointerException(n,mf);
      if (mf->getUnresolvedSnippet() != NULL)
   ...
   S390RSInstruction(TR::InstOpCode::Mnemonic op,
                        ...
                        TR::MemoryReference      *mf,
                        TR::CodeGenerator        *cg)
           : S390RegInstruction(op, n, freg, cg), _sourceImmediate(0), _maskImmediate(0), _idx(-1), _hasMask(false), _hasImmediate(false), _kind(IsRS)
      {
      if (getOpCode().setsOperand2())
   ...
   S390RSInstruction(TR::InstOpCode::Mnemonic op,
                        ...
                        TR::Instruction          *precedingInstruction,
                        TR::CodeGenerator        *cg)
           : S390RegInstruction(op, n, freg, precedingInstruction, cg), _sourceImmediate(0), _maskImmediate(0), _idx(-1), _hasMask(false), _hasImmediate(false), _kind(IsRS)
      {
   ...
   S390RSInstruction(TR::InstOpCode::Mnemonic op,
                        ...
                        TR::MemoryReference      *mf,
                        TR::CodeGenerator        *cg)
           : S390RegInstruction(op, n, regp, cg), _sourceImmediate(0), _maskImmediate(0), _idx(-1), _hasMask(false), _hasImmediate(false), _kind(IsRS)
     {
     useSourceMemoryReference(mf);
     setupThrowsImplicitNullPointerException(n,mf);
     if (mf->getUnresolvedSnippet() != NULL)
   ...
   S390RSInstruction(TR::InstOpCode::Mnemonic op,
                        ...
                        TR::Instruction          *precedingInstruction,
                        TR::CodeGenerator        *cg)
           : S390RegInstruction(op, n, regp, precedingInstruction, cg), _sourceImmediate(0), _maskImmediate(0), _idx(-1), _hasMask(false), _hasImmediate(false), _kind(IsRS)
      {
      useSourceMemoryReference(mf);
      setupThrowsImplicitNullPointerException(n,mf);
      if (mf->getUnresolvedSnippet() != NULL)
   ...
   S390RSInstruction(TR::InstOpCode::Mnemonic    op,
                        ...
                        TR::CodeGenerator *cg)
           : S390RegInstruction(op, n, treg, precedingInstruction, cg),
             _sourceImmediate(imm), _maskImmediate(0), _idx(-1), _hasMask(false), _hasImmediate(true), _kind(IsRS)
        {
        if (getOpCode().setsOperand2())
           useTargetRegister(sreg);
        else
   ...
   bool     hasImmediate()                  {return _hasImmediate;}
