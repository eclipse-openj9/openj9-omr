...
TR_Debug::getRuntimeHelperName(int32_t index)
   ...
   if (index < TR_FSRH)
      ...
      switch (index)
         ...
         case TR_S390interpretedResolvedStaticOrSpecialCallsGlueRX:  return "_interpretedResolvedStaticOrSpecialCallsGlueRX";
         case TR_S390interpretedUnresolvedStaticCallGlueRX:          return "_interpretedUnresolvedStaticCallGlueRX";
         case TR_S390interpretedUnresolvedSpecialCallGlueRX:         return "_interpretedUnresolvedSpecialCallGlueRX";
         case TR_S390nativeStaticHelperRX:                           return "_nativeStaticHelperRX";
