 ...
 */
   ...
   /* .opcode[1]   = */ 0x00,
   /* .format      = */ PSEUDO,
   /* .minimumALS  = */ CPU::Architecture::TR_UnknownArchitecture,
   ...
   /* .opcode[1]   = */ 0x00,
   /* .format      = */ RXa_FORMAT,
   /* .minimumALS  = */ CPU::Architecture::TR_z900,
   /* .properties  = */ S390OpProp_Is32Bit |
                        S390OpProp_SetsCC |
                        S390OpProp_SetsSignFlag |
                        S390OpProp_SetsOverflowFlag |
   ...
   /* .opcode[1]   = */ 0x08,
   /* .format      = */ RXYa_FORMAT,
   /* .minimumALS  = */ CPU::Architecture::TR_z990,
   /* .properties  = */ S390OpProp_Is64Bit |
                        S390OpProp_SetsCC |
                        S390OpProp_SetsSignFlag |
                        S390OpProp_SetsOverflowFlag |
   ...
   /* .opcode[1]   = */ 0xD2,
   /* .format      = */ RRFa_FORMAT,
   /* .minimumALS  = */ CPU::Architecture::TR_z9,
   /* .properties  = */ S390OpProp_DoubleFP |
                        S390OpProp_Is64Bit |
                        S390OpProp_SetsCC |
                        S390OpProp_SetsSignFlag |
   ...
   /* .opcode[1]   = */ 0x7A,
   /* .format      = */ SIY_FORMAT,
   /* .minimumALS  = */ CPU::Architecture::TR_z10,
   /* .properties  = */ S390OpProp_Is64Bit |
                        S390OpProp_SetsCC |
                        S390OpProp_SetsSignFlag |
                        S390OpProp_SetsOverflowFlag |
   ...
   /* .opcode[1]   = */ 0xD9,
   /* .format      = */ RIEd_FORMAT,
   /* .minimumALS  = */ CPU::Architecture::TR_z196,
   /* .properties  = */ S390OpProp_Is64Bit |
                        S390OpProp_SetsCC |
                        S390OpProp_SetsSignFlag |
                        S390OpProp_SetsOverflowFlag |
   ...
   /* .opcode[1]   = */ 0xE1,
   /* .format      = */ RRFc_FORMAT,
   /* .minimumALS  = */ CPU::Architecture::TR_z15,
   /* .properties  = */ S390OpProp_Is64Bit |
                        S390OpProp_UsesTarget |
                        S390OpProp_SetsCC |
                        S390OpProp_SetsZeroFlag |
   ...
   /* .opcode[1]   = */ 0x00,
   /* .format      = */ SMI_FORMAT,
   /* .minimumALS  = */ CPU::Architecture::TR_zEC12,
   /* .properties  = */ S390OpProp_None
   },
   ...
   /* .opcode[1]   = */ 0xAE,
   /* .format      = */ RSLb_FORMAT,
   /* .minimumALS  = */ CPU::Architecture::TR_z13,
   /* .properties  = */ S390OpProp_DoubleFP |
                        S390OpProp_Is64Bit |
                        S390OpProp_IsLoad |
                        S390OpProp_SetsOperand1
   ...
   /* .opcode[1]   = */ 0x38,
   /* .format      = */ RXYa_FORMAT,
   /* .minimumALS  = */ CPU::Architecture::TR_z14,
   /* .properties  = */ S390OpProp_Is64Bit |
                        S390OpProp_SetsCC |
                        S390OpProp_SetsSignFlag |
                        S390OpProp_SetsOverflowFlag |
